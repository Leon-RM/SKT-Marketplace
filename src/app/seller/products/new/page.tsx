...
import { PlusIcon, InfoIcon, CameraIcon, CheckIcon, ChevronLeftIcon, ClockIcon, PackageIcon, XIcon } from '@/components/ui/Icons';
            ...
            <main className="page-container">
                <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                    ...
                    <h1 style={{ marginBottom: 'var(--space-8)', display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                        <span style={{ color: 'var(--color-primary)', display: 'flex' }}><PlusIcon size={32} /></span>
                        เพิ่มสินค้าใหม่
                    </h1>
                    ...
                    <FeatureHint
                        ...
                        title="เคล็ดลับ"
                        text="รูปภาพที่ชัดและสวยจะช่วยให้ขายได้ดีขึ้น ใส่รายละเอียดให้ครบถ้วน"
                    />
